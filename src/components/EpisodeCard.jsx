...
const EpisodeCard = ({ episodeNumber, title, description, imageSrc }) => {
  return (
    <div className='w-[570px] h-[249px] border-2 border-black rounded-12 p-4 bg-white group hover:cursor-pointer hover:drop-shadow-card transition-all'>
      <div className='flex items-center mb-5'>
        ...
        <div className='flex flex-col text-left font-bold'>
          ...
          <p className='font-medium text-14 text-grey'>{description}</p>
        </div>
      </div>
      <div className='flex justify-between'>
        ...
        <div className='flex items-center'>
          ...
          <div className='flex max-w-[46px] overflow-clip'>
            <Avatar className='min-w-[28px] h-[28px] border-2 border-white' />
            <Avatar className='min-w-[28px] h-[28px] border-2 border-white -ml-2 rounded-full' />
          </div>
        </div>
      </div>
    </div>
